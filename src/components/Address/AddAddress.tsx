  ...
  return (
    <main className="  w-full  h-full flex flex-col ">
      <section className=" flex justify-between items-center border-b-[0.1px] pb-3 ">
        <h1 className="  w-full text-[1.1rem]  tracking-widest font-semibold  text-gray-800 dark:text-white/95">Add Address</h1>
      ...
      <section className=" w-full mt-5  ">
        <button className=" border-[0.1px] px-10 py-2 font-medium ">Add Address</button>
      </section>
    </main>
  );
};
