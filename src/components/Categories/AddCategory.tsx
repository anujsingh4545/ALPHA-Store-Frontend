  ...
  return (
    <main className="  w-full  h-full flex flex-col ">
      <section className=" flex justify-between items-center border-b-[0.1px] pb-3 ">
        <h1 className="  w-full text-[1.1rem]  tracking-widest font-semibold  text-gray-800 dark:text-white/95">Add Category</h1>
      ...
      <div className=" mt-10 w-full flex flex-col gap-y-5 ">
        ...
        <section className=" flex items-center justify-start gap-x-5 mt-3  text-[0.8rem] ">
          <button className=" px-10 py-2 border-[0.1px]  font-medium tracking-widest ">Add Category</button>
        </section>
      </div>
    </main>
  );
